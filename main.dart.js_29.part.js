...
this.d=d
this.a=e},
alG:function alG(){}},A,I,C,D,E,H,K,F,G
...
B.alG.prototype={
$1(d){return new E.hQ(0,d,new E.p_(d))},
$S:z+0};(function inheritance(){var x=a.inheritMany,w=a.inherit
x(A.w,[B.alE,B.Vw])
w(B.tf,H.eD)
w(B.alG,A.bG)})()
A.d_(b.typeUniverse,JSON.parse('{"tf":{"X":[],"i":[]}}'))
var y={e:A.I("j<fe>"),i:A.I("j<Vw>"),l:A.I("j<i>"),m:A.I("i")};(function constants(){C.k3=new E.fe("test5","author1","00:00:05")
